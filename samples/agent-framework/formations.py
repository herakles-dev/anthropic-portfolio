...
TOOL_PROFILES: dict[str, set[str]] = {
    "full":     {"read_file", "write_file", "edit_file", "bash", "glob_files", "grep", "claim_file", "check_context"},
    "coding":   {"read_file", "write_file", "edit_file", "bash", "glob_files", "grep", "claim_file", "check_context"},
